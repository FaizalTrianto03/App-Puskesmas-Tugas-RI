...
/// Controller untuk halaman Data Pasien (Dokter)
/// Menampilkan SEMUA antrean yang sudah selesai dari semua dokter sebagai bahan referensi
class DataPasienController extends GetxController {
  ...
  /// Load SEMUA antrean yang sudah selesai (dari semua dokter)
  ...
  Future<void> navigateToDetail(Map<String, dynamic> data) async {
    try {
      ...
      if (docSnapshot.exists) {
        ...
        Get.to(() => DetailPemeriksaanView(pasienData: fullData));
      } else {
