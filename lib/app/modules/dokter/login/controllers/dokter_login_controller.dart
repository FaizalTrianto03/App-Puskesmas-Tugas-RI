...
class DokterLoginController extends GetxController {
  ...
  Future<void> _checkAutoLogin() async {
    try {
      ...
      if (savedCredentials != null && savedCredentials['role'] == 'dokter') {
  ...
  Future<void> login() async {
    ...
    try {
      ...
      if (userData != null) {
        ...
        await FCMService.to.setupUserTopicsOnLogin('dokter');
